...
final class AttnSpeaker implements Preference.OnPreferenceClickListener {
	...
	AttnSpeaker(Context context, Resources resources, SharedPreferences sharedPreferences) {
		mContext = context;
	...
	public final boolean onPreferenceClick(final Preference preference) {
        ...
        try {
        	mSelected = Integer.parseInt(SystemProperties.get(Constants.PROP_SPEAKER_ATTN));
		...
		dialog.setSingleChoiceItems(Constants.getAttn(mResources), mSelected,
						new OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								...
								SystemProperties.set(Constants.PROP_SPEAKER_ATTN, "" + arg1);
								preference.setSummary(mContext
										.getText(R.string.current_setting)
										+ ": "
										+ Constants.getAttn(mResources)[arg1].toString());
								mSharedPreferences.edit().putInt("last_speaker_attn", arg1).commit();
								arg0.dismiss();
